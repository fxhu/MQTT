...
public class MqClient {
    ...
    public synchronized boolean connect(){
        ...
        String userName = "A016B95C620DB97C919A7A5006F71AAB5"; //MQID

        String mqTopic = "topic"; //mq topic
        String mqSub = "sub1"; // mq sub
        try {
            if(null == client) {
    ...
    private void resetOptions(){
        String userName = "A016B95C620DB97C919A7A5006F71AAB5"; //MQID
        String accessKey = "D4V/s3zIhkfrjRQ35iFNK6nk9LWJJeX2zDy7oGCu9jk="; //mq access_key
